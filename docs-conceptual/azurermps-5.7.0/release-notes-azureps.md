...
Installatieprogramma voor Azure PowerShell 5.7.0: [koppeling](https://github.com/Azure/azure-powershell/releases/download/v5.7.0-April2018/azure-powershell.5.7.0.msi)

Galeriemodule voor ARM-cmdlets: [koppeling](https://www.powershellgallery.com/packages/AzureRM/5.7.0)

Als u `AzureRM` wilt installeren vanuit de PowerShell Gallery, voert u de volgende opdracht uit:

```powershell
Install-Module -Name AzureRM -Repository PSGallery -Force
```

Als u wilt bijwerken via een oudere versie van `AzureRM`, voert u de volgende opdracht uit:

```powershell
Update-Module -Name AzureRM
```

## <a name="changes-since-last-release"></a>Wijzigingen sinds de laatste versie

#### <a name="general"></a>Algemeen
* Bijgewerkt naar de nieuwste versie van Azure ClientRuntime

#### <a name="azurestorage"></a>Azure.Storage
* Los het probleem dat cmdlets voor het uploaden van Blob en bestanden mislukken op machines waarop FIPS-beleid is ingeschakeld
    - Set-AzureStorageBlobContent
    - Set-AzureStorageFileContent

#### <a name="azurermbilling"></a>AzureRM.Billing
* Nieuwe cmdlet Get-AzureRmEnrollmentAccount
  - cmdlet voor het ophalen van accounts voor inschrijving

#### <a name="azurermcognitiveservices"></a>AzureRM.CognitiveServices
* Integratie met versie 4.0.0 van Cognitive Services Management SDK.
* Voeg de bewerking Get-AzureRmCognitiveServicesAccountUsage toe.

#### <a name="azurermcompute"></a>AzureRM.Compute
* `Get-AzureRmVmssDiskEncryptionStatus` ondersteunt de coderingsstatus op het niveau van de gegevensschijf
* `Get-AzureRmVmssVmDiskEncryptionStatus` ondersteunt de coderingsstatus op het niveau van de gegevensschijf
* Update voor zonetolerante
* New-AzureRmVm en New-AzureRmVmss (eenvoudige parameterset) ondersteunen beschikbaarheidszones.

#### <a name="azurermcontainerregistry"></a>AzureRM.ContainerRegistry
* Koppel de afhankelijkheid van Commands.Resources.Rest en ARM/opslag-SDK's los.

#### <a name="azurermdatalakestore"></a>AzureRM.DataLakeStore
* Foutopsporing toevoegen
* De versie van de ADLS-dataplane-SDK naar 1.1.2 bijwerken
* Export-AzureRmDataLakeStoreItem: parameters PerFileThreadCount, ConcurrentFileCount en geïntroduceerde gelijktijdigheid van parameters afgeschaft
* Import-AzureRMDataLakeStoreItem: parameters PerFileThreadCount, ConcurrentFileCount en geïntroduceerde gelijktijdigheid van parameters afgeschaft
* Get-AzureRMDataLakeStoreItemContent: tail-gedrag voor inhoud die groter is dan 4 MB opgelost
* Set-AzureRMDataLakeStoreItemExpiry: nieuwe parameterset SetRelativeExpiry geïntroduceerd voor het instellen van een relatieve verlooptijd
* Remove-AzureRmDataLakeStoreItem: parameter Clean afgeschaft.

#### <a name="azurermeventhub"></a>AzureRM.EventHub
* AlternameName in New-AzureRmEventHubGeoDRConfiguration opgelost

#### <a name="azurermkeyvault"></a>AzureRM.KeyVault
* Cmdlets bijgewerkt zodat doorsluisscenario's worden opgenomen
* Afschaffingsberichten voor toekomstige wijzigingen toevoegen

#### <a name="azurermnetwork"></a>AzureRM.Network
* Foutbericht voor netwerk-cmdlets oplossen

#### <a name="azurermservicebus"></a>AzureRM.ServiceBus
* Eigenschappen toegevoegd in CorrelationFilter van regels voor de ondersteuning van customproperties
* Help voor New-AzureRmServiceBusGeoDRConfiguration bijgewerkt en uitvoer van regel-cmdlet opgelost
* Automatisch doorsturen van eigenschappen in de cmdlets New-AzureRmServiceBusQueue en New-AzureRmServiceBusSubscription opgelost

#### <a name="azurermsql"></a>AzureRM.Sql
* Voeg nieuwe cmdlet Stop-AzureRmSqlElasticPoolActivity toe voor de ondersteuning van het annuleren van de asynchrone bewerkingen op de elastische pool
* Werk het antwoord voor cmdlets Get-AzureRmSqlDatabaseActivity en Get-AzureRmSqlElasticPoolActivity bij om meer informatie in het antwoord weer te geven

Wijzigingen sinds de laatste versie: https://github.com/Azure/azure-powershell/compare/v5.6.0-March2018...v5.7.0-April2018
