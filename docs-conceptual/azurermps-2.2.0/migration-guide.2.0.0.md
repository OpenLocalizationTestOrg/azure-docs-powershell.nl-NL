...
1. [Verwijdering van de Force-parameters](#removal-of-force-parameters)
2. [Wijziging aan Tag-parameters](#change-of-tag-parameters)
3. [Belangrijke wijzigingen voor Storage-cmdlets](#breaking-changes-to-storage-cmdlets)
4. [Belangrijke wijzigingen voor AD-cmdlets](#breaking-changes-to-ad-cmdlets)

## <a name="removal-of-force-parameters"></a>Verwijdering van de Force-parameters
...
## <a name="change-of-tag-parameters"></a>Wijziging aan Tag-parameters
...
## <a name="breaking-changes-to-ad-cmdlets"></a>Belangrijke wijzigingen voor AD-cmdlets
